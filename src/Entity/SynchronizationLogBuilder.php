 ...
 */
class SynchronizationLogBuilder implements IBuilder
{
	use TBuilder;
	...
	{
		return !SynchronizationLog::isIdGeneratedByStorage();
	}

	/**
	 * @return SynchronizationLog
	 */
	public function build(): SynchronizationLog
	{
		return new SynchronizationLog($this);
	}
